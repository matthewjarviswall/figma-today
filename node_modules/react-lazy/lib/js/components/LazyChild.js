...
var LazyChild = function (_React$PureComponent) {
    ...
    LazyChild.prototype.render = function render() {
        ...
        var child = children ? _react2.default.Children.only(children) : null;

        return _react2.default.createElement(wrapper, Object.assign({}, props, this.state), child && !this.state.isFailed && !this.state.isLoaded ? _react2.default.cloneElement(child, { onError: this.handleError, onLoad: this.handleLoad }) : child);
    };
